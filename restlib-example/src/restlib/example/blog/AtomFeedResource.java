...
public abstract class AtomFeedResource<T extends AtomFeed<U>, U extends AtomEntry<?>> 
            extends UniformResource<T> implements ConnegResource {

    protected AtomFeedResource(final Class<T> messageClass) {
        super(messageClass);
    }

    protected abstract AtomEntryResource<U> atomEntryResource();
