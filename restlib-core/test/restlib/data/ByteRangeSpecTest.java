...
public final class ByteRangeSpecTest extends AbstractValueObjectTest<ByteRangeSpec> {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void of_lastByteLessThanFirstByte() {
        ByteRangeSpec.range(5, 1);
    }

    @Override
    protected List<ByteRangeSpec> newTestSet() {
        return ImmutableList.of(
                    ByteRangeSpec.NONE,
                    ByteRangeSpec.range(0, 10),
                    ByteRangeSpec.range(0, 100),
                    ByteRangeSpec.range(100, 100),
                    ByteRangeSpec.startingAt(10),
